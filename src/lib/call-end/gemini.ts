/**
 * LLM extraction: pass transcript to Gemini with strict system prompt.
 * Returns JSON: intent, matching vertical, language (EN/ES), financial value.
 * Ultra-low latency; used by call-end webhook and Edge Function.
 */
...
const SYSTEM_PROMPT = `You are a strict data extraction system for a bilingual (English/Spanish) AI sales floor CRM at ziarem.com.
From the call transcript, extract structured data and return ONLY a single JSON object. No markdown, no explanation.
...
- preferred_language (string): "EN" or "ES" only
